  ...
  <div class="employee-dashboard">
    ...
    <div :class="['sidebar', { 'sidebar-collapsed': isCollapsed }]">
      ...
      <ul class="sidebar-menu">
        ...
        <li @click="navigateTo('empleados')" :class="{ active: activeSection === 'empleados' }">
    ...
    <div class="main-content">
      ...
      <div v-if="activeSection === 'empleados'">
        <h3>Empleados</h3>
        <p>Contenido de la sección de empleados.</p>
      </div>
...
export default {
  data() {
    return {
      user: {
        name: 'Nombre del Administrador', // Esto se obtendrá del backend
      },
